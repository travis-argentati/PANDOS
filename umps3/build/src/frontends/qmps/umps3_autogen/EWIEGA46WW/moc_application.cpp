...
#include "../../../../../../src/frontends/qmps/application.h"
...
QT_MOC_LITERAL(1, 12, 20), // "MachineConfigChanged"
QT_MOC_LITERAL(2, 33, 0) // ""

    },
    "Application\0MachineConfigChanged\0"
};
...
void Application::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->MachineConfigChanged(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Application::MachineConfigChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Application::MachineConfigChanged()
{
